...
static	t_vec	mult_vec_matrix(t_vec point, t_m3x3 matrix)
{
	...
	result.x = point.x * matrix.m[0][0] + point.y * matrix.m[1][0]
												+ point.z * matrix.m[2][0];
	result.y = point.x * matrix.m[0][1] + point.y * matrix.m[1][1]
												+ point.z * matrix.m[2][1];
	result.z = point.x * matrix.m[0][2] + point.y * matrix.m[1][2]
